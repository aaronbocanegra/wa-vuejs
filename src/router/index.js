...
const router = new Router({
  routes: [
    ...
    },
    {
      ...
      //store.getters.allOptions.permalink_router_structure,
      // Assuming you're using the default permalink structure for posts
      path: '' + [ store.getters.allOptions.permalink_router_structure != undefined ? store.getters.allOptions.permalink_router_structure : '/:year/:month/:day/:postname' ],
      name: 'Post',
