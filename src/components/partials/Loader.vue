<template>
  <div class="loading w-full flex flex-row h-full text-blue-800 items-center justify-center text-black font-hairline text-xl lg:text-3xl">
    <slot></slot>
    <div>LOADING...</div>
    <div>
      <svg xmlns:svg="http://www.w3.org/2000/svg"
           ...
           xml:space="preserve"
           class="fill-current flex h-20 w-20">
